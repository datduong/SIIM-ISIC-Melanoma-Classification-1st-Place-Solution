...
python train.py --kernel-type 9c_b7ns_1e_576_ext_15ep_newfold --data-dir $datadir --data-folder 768 --image-size 576 --enet-type tf_efficientnet_b7_ns --init-lr 1e-5 --use-amp --CUDA_VISIBLE_DEVICES 0,1,2,3 --model-dir $modeldir --log-dir $logdir --num-workers 8 --batch-size 16 --fold '1,2,3,4'
