...
# sbatch --partition=gpu --time=2-12:00:00 --gres=gpu:k80:2 --mem=12g --cpus-per-task=8
...
python evaluate.py --kernel-type 9c_b4ns_448_ext_15ep-newfold --data-dir $datadir --data-folder 512 --image-size 448 --enet-type tf_efficientnet_b4_ns --oof-dir $oofdir
